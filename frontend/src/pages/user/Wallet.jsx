        ...
        <div className="wallet-page-container">
          ...
          <div className="right-container">
            ...
            <li>
              ...
              and ensuring that your password is kept confidential.
            </li>
            <li>
            ...
            <li>
              ...
              harmless from any claims, damages, or other liabilities arising
              from your use of the service.
            </li>
            <li>
              We may update these terms and conditions at any time. By
              continuing to use the wallet service after any such updates, you
